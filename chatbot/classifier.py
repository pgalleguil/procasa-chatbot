...
def clasificar_corredor_externo(mensaje: str) -> dict:
    ...
    explicit = ("soy corredor", "soy corredora", "soy colega", "soy asesora inmobiliaria", "soy asesor inmobiliario", "corredor inmobiliario", "agente inmobiliario", "trabajo en una corredora", "trabajo como corredor", "trabajo en remax", "trabajo en re max", "hacen canje", "aceptan canje", "ofrezco canje", "hago canje", "comparten comision", "trabajan con corredores", "corretaje compartido", "compartir comision", "represento a mi cliente", "represento a un cliente", "representando a mi cliente", "representando a un cliente")
