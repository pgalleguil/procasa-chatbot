...
async def process_user_message(phone: str, message: str, is_from_me: bool = False,
    ...
    # A successful link lookup is authoritative for this turn.  Do not let
    # the older prospect context or a URL/code scan replace it before the
    # canonical link result is applied.
    if not propiedad and not (es_link and temp_prop):
