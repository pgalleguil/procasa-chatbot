...
EFFECTIVE_CONTACT_RESULTS = frozenset({
    ...
    "EFFECTIVE_CONTACT", "FOLLOW_UP_REQUESTED", "VISIT_SCHEDULED", "PROPERTY_UNAVAILABLE", "CLOSED_WON", "CLOSED_LOST",
})
VALID_MANAGEMENT_RESULTS = frozenset({
    ...
    "DISCARDED_VALID_REASON", "SCHEDULE_FOLLOW_UP", "PROPERTY_UNAVAILABLE",
    "VISIT_SCHEDULED", "CLOSED_WON", "CLOSED_LOST",
})
