...
class AppConfig:
    ...
    yapo_search_url_template: str = field(
        default_factory=lambda: os.getenv("YAPO_SEARCH_URL_TEMPLATE", "https://www.yapo.cl/search?q={query}")
    )
    ...
    batch_prefix: str = field(default_factory=lambda: os.getenv("BATCH_PREFIX", "owner_hunt"))
