#!/usr/bin/env python3
# email_campaña_propietarios_regiones.py → VERSIÓN FINAL DEFINITIVA (TODOS LOS CÓDIGOS CLICABLES)
...
# CONFIGURACIÓN
# ==============================================================================
NOMBRE_CAMPANA = "ajuste_precio_regiones_202512"
    ...
    <body>
        <div class="wrapper">
            <div class="card">
                ...
                <div class="content">
                    <p>Hola {nombre},</p>
                    <p>Desde Procasa hemos analizado {texto_prop} (<strong>{codigos_html}</strong>). A pesar de su calidad y buen estándar, la propiedad no ha generado el nivel de movimiento esperado en el último trimestre. El mercado inmobiliario chileno actual en regiones exige ajustes para impulsar mayor visibilidad y acelerar el proceso de venta.</p>
                    <div class="highlight-box">
                        <strong>Sobreoferta en regiones clave:</strong> Stock acumulado en ciudades como Viña del Mar, La Serena, Talca y Chillán supera las <strong>15.000 unidades combinadas</strong> (CChC, Q3 2025), con tiempo de absorción de ~32 meses —más del doble del ideal (14-20 meses)—.<br><br>
                        <strong>Tiempos de Venta Extendidos:</strong> Promedio >160 días en regiones como Valparaíso y Biobío (Colliers y Portalinmobiliario, Q3 2025); propiedades >160 días reciben 65% menos visitas.<br><br>
                        <strong>Restricciones Crediticias:</strong> Tasas hipotecarias en 4.16% (Banco Central, octubre 2025), reduciendo ~18% la capacidad de endeudamiento de compradores regionales.<br><br>
                        <strong>Ajustes para Ventas:</strong> Hasta 80% de cierres en regiones involucran correcciones de 5-9% (Colliers, 2025), bajando precios para competir en portales.
                    </div>
                    <p>Con tasas proyectadas a ~4% para fines de 2025 (Colliers), hay oportunidades, pero mantener precios actuales podría extender la detención 6-11 meses más. Recomendamos un <strong>ajuste del 7%</strong>, basado en >450 transacciones similares en regiones: +280% en consultas iniciales y cierre 38-48% más rápido (datos CChC/Colliers).</p>
...
def main():
    print("="*70)
    print("CAMPAÑA ESTRATEGIA DE PRECIO - REGIONES")
    ...
    pipeline = [
        ...
        },
        {
            "$match": {
                "$and": [
                    {"propiedad_info.region": {"$ne": "XIII Región Metropolitana"}},
                    {"propiedad_info.region": {"$ne": "Región Metropolitana de Santiago"}}  # por si está escrito distinto
                ]
            }
        },
        {
