...
# VERSIÓN 7.3 (CORREGIDA: CC EJECUTIVO + BCC JEFE + BOTÓN NO DISPONIBLE)
...
# ==============================================================================
# MANEJO DE IMÁGENES (LOGO E IDENTIDAD)
# ==============================================================================
def attach_images(msg):
    """Adjunta el logo de Procasa al correo electrónico"""
...
# ==============================================================================
# GENERACIÓN DE HTML (TEXTO ADAPTADO A MERCADO REGIONAL)
# ==============================================================================
def generar_html(nombre_propietario, propiedades, email_real, nombre_asesor):
    ...
    # Construcción de la tabla de propiedades
            ...
            <div style="padding:28px 32px;color:#374151;line-height:1.6;">
                ...
                <div style="text-align:center;margin:30px 0;">
                    ...
                    <a href="{link_mantener}"
                       ...
                       border:2px solid #E5E7EB;margin-bottom:15px;">
                        Mantener precio actual (sin cambios)
                    </a>

                    <a href="{link_no_disponible}"
                       style="display:block;background:#DC2626;color:#FFFFFF;padding:16px;
                       text-decoration:none;border-radius:6px;font-weight:bold;font-size:16px;">
                        🚫 Informar que la propiedad ya no está disponible
                    </a>
                </div>

                <p style="font-size:13px;color:#9CA3AF;text-align:center;">
                    Si desea una estrategia distinta o prefiere conversar,
...
def main():
    ...
    # Pipeline de MongoDB con exclusión de Región Metropolitana
    pipeline = [
        {
            "$match": {
                "tipo": "propietario",
    ...
    for doc in candidatos:
        ...
        # Nombre del asesor (priorizamos campos más comunes)
    ...
    for email_real, data in grouped_data.items():
        ...
        email_asesor_actual = data.get('email_asesor')
        ...
        if not MODO_PRUEBA:
            ...
            # CC al ejecutivo si tiene email
            if email_asesor_actual:
                msg['Cc'] = email_asesor_actual
                destinatarios_finales.append(email_asesor_actual)
    ...
    print(f"Total correos enviados: {enviados}")
