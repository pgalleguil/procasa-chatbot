...
def test_get_commercial_dashboard_resolves_all_parallel_queries(monkeypatch):
    ...
    monkeypatch.setattr(q, "query_variance_drivers", mark("variance_drivers", {"comparable_available": False, "dimensions": {}}))
    ...
    assert {name for name, _ in calls} == {"kpis", "funnel", "sla", "demand", "executives", "properties", "sources", "trends", "variance_drivers", "coverage", "insights", "executive_summary"}
