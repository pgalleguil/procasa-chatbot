#!/usr/bin/env python3
# email_campaña_propietarios_regiones_tercer.py → TERCER ENVÍO - ENERO 2026 - REGIONES
...
# CONFIGURACIÓN
# ==============================================================================
NOMBRE_CAMPANA = "ajuste_precio_regiones_202601_TERCER"
NOMBRE_ANTERIOR = "ajuste_precio_regiones_202512_REPASO"
MODO_PRUEBA = False                                              # ← True = prueba segura (SOLO 1 correo). False = envío real
...
# ==============================================================================
# GENERACIÓN DE HTML - DATOS ACTUALIZADOS ENERO 2026 (REGIONES)
# ==============================================================================
                        ...
                        <tr>
                            <td style="padding: 40px 50px;">
                                ...
                                <p style="color: #475569; font-size: 15px; line-height: 1.7;">
                                    Estimado cliente, iniciamos 2026 con señales positivas en el mercado inmobiliario regional. La <strong>Tasa Hipotecaria se ubica cerca del 4,1%</strong>, significativamente más atractiva que los niveles del año anterior.
                                </p>
                                
                                <p style="color: #475569; font-size: 15px; line-height: 1.7;">
                                    <strong>¿Qué significa esto para usted?</strong> Que hoy existe un flujo creciente de compradores con créditos aprobados buscando invertir en regiones. Sin embargo, con un <b>stock elevado de ~40.000 propiedades</b> en regiones clave, los compradores tienen el poder de elegir. Las estadísticas muestran que las propiedades que ajustan valor al inicio del ciclo de bajas tasas venden más rápido y en mejores condiciones.
                                </p>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td align="center" width="33%" style="border-left: 1px solid #334155; border-right: 1px solid #334155;">
                                                        ...
                                                        <div style="font-size: 20px; font-weight: bold;">~40k Unid.</div>
                                                    </td>
                                                    <td align="center" width="33%">
                                                        <div style="font-size: 10px; color: #94A3B8; text-transform: uppercase;">Plazo Venta</div>
                                                        <div style="font-size: 20px; font-weight: bold;">200+ días</div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <div style="background-color: #F0F9FF; border-left: 4px solid #004A99; padding: 15px; margin-bottom: 30px;">
                                    <p style="margin: 0; font-size: 14px; color: #0C4A6E;">
                                        <strong>Acción Procasa:</strong> Al aplicar el ajuste del 7%, activaremos un <strong>Posicionamiento de Élite Regional</strong>. Su propiedad será destacada como oportunidad de inversión, asegurando mayor visibilidad ante el nuevo flujo de compradores bancarizados en regiones.
                                    </p>
                                </div>
...
def main():
    print("="*80)
    print("TERCER ENVÍO CAMPAÑA AJUSTE PRECIO - ENERO 2026 - REGIONES")
    ...
    print(f"Encontrados {len(grouped_data)} propietarios en regiones para tercer envío.")
