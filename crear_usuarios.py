...
def registro_masivo_chile():
    ...
    lista_usuarios = [
        ...
        #{"email": "pmorales@procasa.cl", "nombre": "Paula Morales", "tel": "+56965366155", "rol": "agente"}
        {"email": "mgalleguillos@procasa.cl", "nombre": "María Paz Galleguillos", "tel": "+56926937730", "rol": "agente"}
