...
def report_lines(
    ...
    return [
        ...
        "",
        "Parámetros congelados: elegibilidad current-policy, lead/ciclo abiertos, SLA vencido, protección por cualquier gestión humana auditable, owner excluido, anti-ping-pong, reasignación continua hasta agotar candidatos, RM global, JPC J3 30–70%, L1, shrinkage K=20, ventana 60 días y capacidad `3*expired+2*unmanaged+open`.",
        "",
        "## RM LONG RUN",
        "",
        ...
        "",
        f"RM candidata utilizada: `{candidate_display}`. Proporción branch histórica RM/JPC: `{rm_count}/{jpc_count}` sobre las ramas definidas. L1, carga compartida, JPC J3, anti-ping-pong y reasignación continua activos en la simulación.",
        "",
        "## STRESS",
        "",
        ...
        "6. Anti-ping-pong permanece activo y el contador de reasignaciones no impone un máximo numérico.",
        ...
        "## TESTS",
        "",
        "- nuevos: long run R0/R1/R2/R3, criterios ACCEPTABLE, determinismo, N500, JPC N250, combinado, carga Hernán, S0–S5, L1, anti-ping-pong, reasignación continua, contrato, precondiciones, policy version, exclusión regional/review y Mongo writes=0.",
...
def main() -> None:
    ...
    validation = {
        ...
        "anti_ping_pong": True,
        "continuous_reassignments": contract["automatic_reassignment_counter"],
